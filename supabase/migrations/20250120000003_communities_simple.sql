-- Migration simplifiée pour les communautés de quartier
-- Version compatible avec Supabase sans extensions PostgreSQL spéciales
...
CREATE INDEX IF NOT EXISTS idx_discussions_pinned ON community_discussions(is_pinned);
...
COMMENT ON FUNCTION calculate_distance_km IS 'Calcule la distance entre deux points géographiques en km';
