...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost: 'bg-white/80 backdrop-blur-xl border border-white/20 text-gray-700 hover:bg-white/90 hover:border-white/30 hover:shadow-xl disabled:text-gray-400 disabled:bg-gray-100/60',
