...
// import { useProfile } from '../hooks/useProfiles'; // Import non utilisé
...
const ItemDetailPage: React.FC = () => {
  ...
  // const { data: currentUserProfile } = useProfile(user?.id); // Variable non utilisée
  // const [userLocation, setUserLocation] = useState<{lat: number, lng: number} | null>(null); // Variable non utilisée
